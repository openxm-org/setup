...
This is a binary of [Risa/Asir](http://www.math.kobe-u.ac.jp/Asir/index.html) (version 20250328) for Android (**Arm 64bit**).  
This binary was checked on Android 15(Google Pixel 6a).
...
2.  Execute the following on Termux:  
    $ curl -O https://openxm-org.github.io/setup/2025/android/install.sh  
    $ sh install.sh  
    $ exit
